...
export default function EditBlogPost({ params: paramsPromise }) {
        ...
        const fetchData = async () => {
            ...
            if (postRes.data) {
                setFormData({
                    ...
                    image_url: postRes.data.image_url || '',
                    category_id: postRes.data.category_id || '',
                    author_name: postRes.data.author_name || 'Nano Team',
                    status: postRes.data.status || 'published',
                    published_at: postRes.data.published_at 
                        ? new Date(postRes.data.published_at).toISOString().slice(0, 16) 
    ...
    const handleSave = async (e) => {
        ...
        if (error) {
            ...
            toast.success(formData.status === 'draft' ? 'Draft saved!' : 'Post updated!');
            router.push('/admin/blog');
        }
    };
    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center h-[60vh] gap-4">
                ...
                <p className="text-[13px] font-black text-gray-400 uppercase tracking-widest">Loading Post...</p>
            </div>
        );
    }
        ...
        <div className="space-y-6 max-w-[1100px]">
            ...
            <div className="flex items-center justify-between pt-2">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-[22px] font-black text-gray-900">Edit Story</h1>
                        <p className="text-[13px] text-gray-400 font-medium mt-0.5">Updating: {formData.title}</p>
                    </div>
                </div>
                <div className="flex items-center gap-3">
                    <button 
                    ...
                    >
                        ...
                        {saving ? 'Saving...' : (formData.status === 'draft' ? 'Save Draft' : 'Save Changes')}
                    </button>
                </div>
            </div>
                    ...
                    <div className="bg-white border border-gray-100 rounded-2xl p-8">
                        ...
                        <div className="mb-6">
                            ...
                            <input 
                                ...
                                required
                                className="w-full text-[28px] font-black text-gray-900 placeholder:text-gray-200 bg-transparent border-none focus:outline-none focus:ring-0 leading-tight"
                            />
                        </div>
